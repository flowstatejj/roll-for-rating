...
const STRINGS: Record<LangCode, Record<string, string>> = {
  en: {
    ...
    'le.scoring': 'Scoring', 'le.winsOnly': 'Wins only', 'le.killBonus': 'Kill (choke) bonus', 'le.breakBonus': 'Break (lock) bonus', 'le.subBonusHint': 'Extra points added when a win is by submission.',
    ...
    'tn.scoring': 'Scoring', 'tn.winsOnly': 'Wins only', 'tn.killBonus': 'Kill bonus', 'tn.breakBonus': 'Break bonus', 'tn.mats': 'Mats', 'tn.subBonusHint': 'Bonus points when a win is by submission.',
  ...
  es: {
    ...
    'le.scoring': 'Puntuación', 'le.winsOnly': 'Solo victorias', 'le.killBonus': 'Bono estrangulación', 'le.breakBonus': 'Bono llave', 'le.subBonusHint': 'Puntos extra cuando se gana por sumisión.',
    ...
    'tn.scoring': 'Puntuación', 'tn.winsOnly': 'Solo victorias', 'tn.killBonus': 'Bono estrangulación', 'tn.breakBonus': 'Bono llave', 'tn.mats': 'Áreas', 'tn.subBonusHint': 'Puntos extra cuando se gana por sumisión.',
  ...
  pt: {
    ...
    'le.scoring': 'Pontuação', 'le.winsOnly': 'Só vitórias', 'le.killBonus': 'Bônus estrangulamento', 'le.breakBonus': 'Bônus chave', 'le.subBonusHint': 'Pontos extras quando vence por finalização.',
    ...
    'tn.scoring': 'Pontuação', 'tn.winsOnly': 'Só vitórias', 'tn.killBonus': 'Bônus estrangulamento', 'tn.breakBonus': 'Bônus chave', 'tn.mats': 'Áreas', 'tn.subBonusHint': 'Pontos extras quando vence por finalização.',
  ...
  fr: {
    ...
    'le.scoring': 'Score', 'le.winsOnly': 'Victoires seules', 'le.killBonus': 'Bonus étranglement', 'le.breakBonus': 'Bonus clé', 'le.subBonusHint': 'Points bonus quand on gagne par soumission.',
    ...
    'tn.scoring': 'Score', 'tn.winsOnly': 'Victoires seules', 'tn.killBonus': 'Bonus étranglement', 'tn.breakBonus': 'Bonus clé', 'tn.mats': 'Tapis', 'tn.subBonusHint': 'Points bonus quand on gagne par soumission.',
