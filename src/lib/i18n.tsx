...
const STRINGS: Record<LangCode, Record<string, string>> = {
  en: {
    ...
    'code.invalid': 'Code not recognized - check it and try again.',
    'code.pendingInvalid': 'Your referral code was not recognized. You can re-enter it in Settings.',
  ...
  es: {
    ...
    'code.invalid': 'Código no reconocido: revísalo e inténtalo de nuevo.',
    'code.pendingInvalid': 'Tu código de referido no fue reconocido. Puedes reingresarlo en Ajustes.',
  ...
  pt: {
    ...
    'code.invalid': 'Código não reconhecido: confira e tente de novo.',
    'code.pendingInvalid': 'Seu código de indicação não foi reconhecido. Você pode reinseri-lo em Configurações.',
  ...
  fr: {
    ...
    'code.invalid': 'Code non reconnu : vérifie-le et réessaie.',
    'code.pendingInvalid': 'Ton code de parrainage n’a pas été reconnu. Tu peux le ressaisir dans les Paramètres.',
